# PART G — full draft, chapters 25–31

*All seven chapters: prose, vignettes and apparatus, in reading order.*
*Merged from the working files so the whole part travels as one attachment.*
...
of it, and went home; the last one had met at Odense in 1657, and voted the money
for the war that produced this debt. What Frederik 3.
...
# Chapter 25 — apparatus

*Draft. Glossary blocks are per-section (`Danish terms in this section`), so they
are listed under the section they attach to. Question tiers follow the series:
Recall, Causal, Counterfactual, Contested.*
...
**§03 — hereditary, then absolute**

- **arvekongedømme** — hereditary monarchy, as against an elective one. The crown
  descends in the king's house instead of being conferred by the council.
- **arvehyldning** — the ceremony of homage to a hereditary king, held on 18
  October 1660 on the square between Copenhagen Castle and the Børsen.
...
- **Kongeloven** — the King's Law of 1665. Europe's only written constitution of
  absolute monarchy, and almost entirely a list of things the king may do.

**§05 — colleges and amter**

- **kollegium** — a standing government office with one field of business, run by
  a board. The colleges replaced a council that had discussed everything.
- **len** — a fief: a district whose revenue a nobleman collected for the crown,
  keeping an agreed share.
- **amt** — the district that replaced it after 1662, run by an **amtmand**, a
  salaried official who could be moved or dismissed.

**§06 — the land written down**

- **jordebog** — an estate book, listing what each tenant farm owed its landlord.
  Every estate kept one and no two were alike.
- **matrikel** — a land register. The 1662 and 1664 registers were not surveys:
  they converted existing dues into a common unit.
- **hartkorn** — "hard grain", the unit that unit was. One barrel of hartkorn
  equalled a barrel of rye or barley, or two of oats, and divided into eight
  *skæpper*. Danish land was valued in it until 1903.
- **ryttergods** — crown estates whose revenue was assigned to a cavalry district,
  so that a regiment was fed by the land it stood on.
...
**Checkpoint (after §03)** — Before going on, three things are worth holding.
The estates met to solve a debt, not to change the constitution. The proposal to
...
the standing army, the rank order of 1671, the tax that paid for the wars, the
reforms of the 1780s — is done with that arithmetic.

**Checkpoint (after §08)** — Absolutism in Denmark was not imposed on the
country by force, and it was not resisted. No one was executed for opposing it.
The nobility kept its land. That is what makes 1660 difficult: it is a revolution
with no victims at the time, whose costs are paid by people who were not in the
room and were not asked.
...
when a state decided to use it becomes visible in the 1730s.

**→ Part H.** A monarchy with no written limit on it, and no institution left with
standing to argue, has no mechanism for changing its mind. That is the problem
Denmark takes to 1848.
...
write about: a revolution with no victims looks like a negotiation, and the
negotiation was conducted between a crown and two estates over the head of a
third.
...
8. Suppose the nobility had accepted equal taxation on 19 September. What would
   the estates meeting have been remembered for?
9. Suppose the Kongelov had been printed in 1665 rather than 1709. Would anything
   have been different — and for whom?

**Contested** — *Where the argument still is*

10. How much weight can the closing of Copenhagen's gates on 10 October carry?
    Make the strongest case for reading it as coercion, then the strongest case
    against, and say which you find harder to dismiss.
...
- Sebastian Olden-Jørgensen has written extensively on 1660 and on the ceremonial
  and political language of early Danish absolutism, and represents the sceptical
  reading of the conspiracy narrative.
- Knud J.V. Jespersen has placed the change in the context of the military
  revolution: a state that had to build a standing army and could not do it under
  the old fiscal constitution.
- Leon Jespersen's work on the rigsråd and the seventeenth-century council is the
  place to go for what the nobility thought it was defending.
- C.O. Bøggild-Andersen's study of Hannibal Sehested set out the case that
  reform of the administration was already under way before 1660, which is the
  view this chapter takes in §05.
...
- **Danske Lov** — the law of 15 April 1683, in six books, the first single code
...
- **friskytte** — a free-shooter: an irregular in Danish pay, under Danish
  command, operating behind the Swedish lines.
- **snaphane** — the Swedish word for the same men, and previously for highway
  robbers. Which word a source uses tells you which country wrote it.
- **gønge** — the Danish word, from Göinge in north-eastern Skåne, where the
  resistance was strongest.

**§08 — making Skåne Swedish**
...
**Checkpoint (after §03)** — Griffenfeld is easy to remember as a tragedy and
harder to remember as an argument. Hold the argument: he was a commoner who built
a state in which commoners could rise, he enriched himself doing it, and the men
who destroyed him were soldiers who wanted a war he thought Denmark could not win.
...
is assassinated, the snaphaner come off badly, and Sweden is Skåne's natural
homeland. Two nations wrote novels about one obscure officer and gave him opposite
deaths. Neither is evidence of anything except what each country needed the 1670s
to have been.
...
the Norwegian apparatus is usually described.
...
8. Suppose Griffenfeld had kept his office through 1676. He wanted an
   accommodation with France and Sweden. What would that have cost Denmark, and
   what would it have saved?
9. Suppose Sophie Amalie had died in 1670 rather than 1685. What would Danish
   readers have inherited instead of *Jammers Minde*?
...
- On Griffenfeld the Danish tradition has swung between the corrupt careerist of
  the 1676 indictment and the far-sighted statesman of the nineteenth-century
  rehabilitation; both readings are still in print, and this chapter takes
  neither whole.
...
> creek cannot manoeuvre and cannot run, which is why nobody expected an attack
...
>
> She stays fourteen years, and what she runs is the part of a colony that does not
> get written down: the household, which in a place with no supply and no
...
- **karantæne** — from the Italian for forty. Travellers were held on Saltholm for
  forty days from 1709.
- **sundhedskommission** — the health commission, given emergency powers on 7 July
  1711; it met twice daily.
- **pestlazaret** — a plague hospital, set up outside the ramparts by the lakes.
...
- **Tordenskjolds soldater** — still an idiom in Danish and Norwegian for the same
  few people shown repeatedly to look like many.
...
- **vornedskab** — the bond tying a Zealand peasant to the estate where he was
  born. Abolished 1702, and not replaced until 1733.
- **kirketiende** — the church tithe, which paid the schools' running costs.

**§09 — Greenland**

- **nordboerne** — the Norse of Greenland, out of contact since about 1410. Egede
  went to find them and did not.
...
bubble and a Danish treaty guaranteeing a border by the exchange of parchment. The
eighteenth century is generally remembered for the first. Denmark spent it living
off the second.
...
**The myth.** At Marstrand in 1719 Tordenskjold tricked the Swedish garrison into
...
been enough. He was a genuinely audacious officer whose reputation rests on real
actions — Dynekilen in 1716 was not a trick.

**Where the caution belongs.** The circling-soldiers story is the kind of anecdote
...
**← 23.** Sweden's exemption from the Sound dues, won at Brömsebro in 1645, is
...
- The rytterskole instructions of 28 March 1721, and the sandstone tablets, many
  of which are still in place.
- Hans Egede, *Relationer fra Grønland 1721–36* and *Det gamle Grønlands ny
  Perlustration*, 1741.
...
- Finn Gad's history of Greenland remains the fullest Danish treatment of the
  colony's first decades; the Greenlandic reassessment of Egede since the 1970s is
  a separate and now larger literature.
- On the Gottorp question, the Danish and the Schleswig-Holstein traditions have
  never agreed about whether 1721 was a lawful forfeiture or an annexation, and
  the nineteenth-century versions of both were written to serve the later dispute.
- Ole Feldbæk on Denmark's eighteenth-century foreign policy, for the argument that
  the great-power guarantee mattered more than anything Denmark did militarily.

---

## Visit

**Avderød rytterskole, Fredensborg.** One of the best-preserved of the 1722–27
schools, in public ownership its whole life and now a local museum. The sandstone
tablet with the verse is over the door.

**Hvidovre Kirkeplads, Copenhagen.** Another one, beside the church, as they all
...
**Skolen ved Søerne, Frederiksberg.** Under the schoolyard lie hundreds of the
plague dead of 1711, buried at a temporary hospital that stood outside the
ramparts. Among the skeletons excavated was a pregnant woman.
...
**§02 — the parish under pietism**

- **pietisme** — a movement holding that inward conversion mattered more than
  correct doctrine correctly recited. It arrived as a criticism of the state
  church and was made into an instrument of it.
- **konfirmation** — compulsory from 13 January 1736: public examination in
  church before admission to communion, and in practice before adulthood.
- **katekismus** — Luther's Little Catechism, and Pontoppidan's explanation of it,
  *Sandhed til Gudfrygtighed*, with its seven hundred and fifty-nine questions.
- **konventikelplakaten** — the Conventicle Placard of 1741, which put private
  religious gatherings under the parish priest's supervision.
...
- **hoveri** — the compulsory labour a tenant owed on his landlord's home farm.
  Never specified in the tenancy letter and subject to no legal ceiling.
- **spanddag** — a day owed with a wagon and a team.
- **gangdag** — a day owed on foot with hand tools, which could be met by sending
  a girl or a boy.
- **hovlod** — a defined strip of the manor's field allotted to one tenant to work.
- **fæstebrev** — the tenancy letter. It said a man must do hoveri like his
  neighbours, or as often as he was called, and nothing more precise than that.
- **husmand** — a cottager with little or no land, who generally had nobody to
  send in his place.
...
- **Brødremenigheden** — the Moravian Brethren, called Herrnhuters after the
  Saxon village where they refounded themselves in 1727.
- **kor** — the choir: the group by sex, age and marital status into which every
  member of a Moravian town was placed, with a house to match.

**§07 — Norway**

- **stattholder** — the royal governor in Norway. Often vacant; filled with real
  power whenever the sea route to Copenhagen was cut.
- **odelsret** — the family's ancestral right in its land, kept by Norske Lov of
  1687 when almost everything else followed the Danish code.
- **bergstad** — a mining town. Kongsberg was the second largest town in Norway in
  1770, after Bergen.
...
- **kornmonopol** — the ban of 1735 on importing foreign grain, which gave Danish
  agriculture the market of Denmark and southern Norway.
- **Kurantbanken** — Denmark's first bank, chartered 1736, issuing notes
...
rearranged the people it already had. Whether that was wisdom or luck is a fair
question. It was certainly cheaper.

**1755 — Lisbon.** On the morning of All Saints' Day 1755 an earthquake, a
...
**Checkpoint (after §04)** — The two famous facts about the eighteenth-century
...
**The myth.** Stavnsbånd was Danish serfdom, and its abolition in 1788 freed the
peasantry.

**What is true.** The bond was real, it was national, and it was deliberate. From
1764 a man could be tied to the estate of his birth from the age of four until he
was forty.
...
sea was closed, and an obligation to buy Danish bread.
...
- The Stavnsbånd ordinance of 4 February 1733, printed in Christian 6.'s
  ordinances for 1732–33.
- The Sabbath ordinance of 12 March 1735 and the confirmation ordinance of 13
  January 1736.
...
- Ole Feldbæk's *Danmarks økonomiske historie 1500–1840* is the standard account of
  ...
  that the significance of both the bond and the monopoly is uncertain.
- Birgit Løgstrup's work on the landowner as public administrator is where to go
  for how the estate actually functioned as an arm of the state.
- Claus Bjørn on hoveri and the agrarian reforms; Jens Holmgaard on whether the
  militia was as heavy a burden as it is remembered to be.
- Martin Schwarz Lausten's church history for the pietist decades.
- The Norwegian literature reads this period differently from the Danish, and has
  since 1814. Both traditions are describing the same grain law.

---

## Visit

**Christiansfeld.** The Moravian town, on the UNESCO World Heritage list, with the
church square, the brothers' house and the sisters' house still standing, and the
...
**Ørsted, Oksenvad sogn**, in Haderslev Amt. A village of no particular
distinction, which is the reason it matters: two families here wrote things down
for two hundred years, and one of them recorded the cattle plague from inside the
byre.

**Any parish church with a gallery.** The confirmation ordinance of 1736 is the
reason a great many Danish village churches acquired seating for children in the
following decades, and the reason their registers begin recording who was
confirmed.
...
censorship reintroduced a form of it thirteen months later, because it was being
used against him.
...
> In 1793 he sells it.
>
> What he asks in the bargain is worth reading slowly. Six tønder of land with the
...
<!-- ===== c29_draft_apparatus.md ===== -->

# Chapter 29 — apparatus
...
- **landbokommission** — an agrarian commission. The small one of 1784 worked on
  the crown estates; the great one of 1786 drafted the reform legislation.
- **udskiftning** — the exchange and consolidation of a village's scattered strips
  into single holdings.
- **stjerneudskiftning** — the star pattern: farms left in the village with their
  new land running outward in wedges.
- **udflytning** — moving the farmstead out of the village onto its own ground.
- **fællesskab** — the village community that decided together when to plough,
  sow and graze, and which the reforms dissolved.
- **arvefæste** — hereditary tenancy: the tenancy passes to the heir, and the
  holder may buy and sell in a limited way, while still owing the estate a due.
- **selveje** — outright freehold.

**§09–10 — after**

- **Frihedsstøtten** — the Liberty Column, 1792–97, twenty metres of Bornholm
  sandstone on Norwegian marble, outside the old Vesterport.
- **gårdmand** — a man with a holding. The reforms were about him.
- **husmand** — a cottager with a house, a garden and little or no land. The
  reforms were not about him.

---

## Meanwhile in Europe

**1776 — Philadelphia.** The Declaration of Independence was adopted on 4 July
1776, in the same year that Guldberg's Denmark passed a law reserving public
office to the native-born. Both documents are about who belongs to a state and on
what terms, and they answer the question in opposite directions: one by asserting
rights held by men as such, the other by drawing a line around a birthplace.
Denmark also did very well out of the war that followed, as a neutral carrier —
the trade boom that begins here runs into chapter 31 and ends in the harbour at
Copenhagen in 1807.

**1789 — Paris.** The Bastille fell on 14 July 1789, a year and three weeks
after the Danish ordinance of 20 June 1788 — near enough that the two are usually
read together, and far enough apart that neither caused the other. It is worth holding the two together without
...
**Checkpoint (after §06)** — Watch the instrument, not the man. Struensee ruled by
...
**The myth.** Struensee issued 1,069 cabinet orders.

**The problem.** So do 1,800, 2,000 and 2,200, depending on which reputable source
you open, and the last counts from 1769 rather than 1770. A precise-looking figure
repeated confidently is not evidence that anybody has counted. The honest statement
is that he legislated at a rate nobody before or since has attempted in Denmark,
...
basis of its work — conceding, eighty-four years on, that the bond had been an
aberration.
...
**→ 31.** Neutral Denmark's trade boom begins under Guldberg during the American
war. — The crown prince who took power at sixteen in 1784 is Frederik 6., and he
holds it until 1839.
...
queen, so that by October 1771 he was restricting it himself.

Officers, the dowager queen and the hereditary prince took the king's signature at
four in the morning on 17 January 1772 and arrested them both. Struensee was
executed in April; the queen was divorced, exiled to Celle and dead at
twenty-three.

Ove Høegh-Guldberg then governed for twelve years by exactly the means he had
overthrown Struensee for using, and passed the Indfødsret of 1776 reserving office
...
8. Suppose Christian 7. had been well. Would any of Struensee's reforms have
   happened, and would they have lasted longer?
9. Suppose the ordinance of 1788 had abolished the tie to the home district
   outright rather than transferring it to the state. What would have changed, and
   for whom?
...
- The cabinet order of 4 September 1770 and the rescript of 14 September 1770.
- The Indfødsret of 1776.
- The ordinances of 8 June 1787 and the ordinance of 20 June 1788.
- C.D.F. Reventlow's Minerva speech, 15 August 1788.
- Caroline Mathilde's signed confession of 9 March 1772, Rigsarkivet.
...
- Birgit Løgstrup, *Bondens frisættelse: de danske landboreformer 1750–1810*
  ...
  reforms came from below as much as from above.
- Svend Cedergreen Bech's *Struensee og hans tid* remains the fullest Danish
  treatment of the sixteen months.
- The Danish and the German literatures on Struensee have never quite agreed about
  whether he was an enlightened statesman or an adventurer, and the answer tends
  to follow the writer's view of enlightened absolutism generally.
- On Caroline Mathilde, the nineteenth-century treatments are largely romantic and
  the recent ones largely political; this chapter follows the second.
...
**Kronborg.** Where Caroline Mathilde was held for four months in 1772, with her
infant daughter, and where she signed the confession.

**Brahetrolleborg, Funen.** The courtyard where Johan Ludvig Reventlow let the
tenants break the wooden horse and the pillory in 1777, and where he handed them
hereditary tenancy letters on 14 September 1788. The school he founded is part of
the same project.

**Any village on a nineteenth-century map.** Look for the star: farms at the
centre with wedge-shaped fields radiating outward, or a village with gaps in it
where the farms that were moved out used to stand. The pattern is everywhere in
Denmark once you know to look for it, and it is the most widespread physical trace
any Danish reform has left.
...
<!-- ===== c30_draft_apparatus.md ===== -->

# Chapter 30 — apparatus
...
**§01–02 — before the Atlantic**

- **oktroj** — a royal charter granting a company a monopoly on a trade, with the
  powers of government that went with it.
...
- **Akwamu** — the West African state whose collapse put many of its people,
...
- **Forordning om Negerhandelen** — the ordinance of 16 March 1792, banning the
  trade from 1803 and licensing it until then.
...
**The myth.** Denmark was the first country to abolish slavery.

**Three corrections, in order of size.**

*It was not slavery.* The ordinance of 1792 abolished the transatlantic *trade*.
Slavery in the Danish West Indies remained entirely lawful, and people continued to
...
**← 24.** Jens Kofoed's rising on Bornholm in 1658 is told in Danish history as a
...
four plantations in 1763, at the point where chapter 28's economy was recovering.
...
8. Suppose the Akwamu had held St Jan. They intended to run the plantations with
   enslaved people of other African origins. What would that island have been, and
   how should a history describe it?
9. Suppose Britain had abolished its trade in 1788 rather than 1807. Would Denmark
   have moved earlier, later, or not at all?
...
- Governor Philip Gardelin's slave code, 5 September 1733.
- *Forordning om Negerhandelen*, 16 March 1792.
- Ernst Schimmelmann's *pro memoria* and covering letter on the slave trade, Sølyst,
  18 June 1791; and the report of the slave-trade commission, 28 December 1791,
  Rigsarkivet, Generaltoldkammeret.
- The captain's journal and ship's assistant's protocol of the *Fredensborg*,
  1767–68, Rigsarkivet — digitised and transcribed by KUBEN, Arendal.
- The printed map of St Croix, 1754.
- danmarkshistorien.dk, Aarhus University, on the trade, the company and the
  ordinance.
...
- Leif Svalesen, *Slaveskipet Fredensborg og den dansk-norske slavehandel på
  1700-tallet* (1996), for the voyage.
- Louise Sebro, *Slaveoprøret på Sankt Jan: 1733*, for the rising as something
  other than a spontaneous revolt.
- Per Hernæs and others, *Vestafrika: Forterne på Guldkysten* (2017), in the Gads
  five-volume *Danmark og kolonierne*.
- The Danish literature has changed sharply since about 2015, and the older
...
emancipation was declared in 1848, after the rising.

**Fortsberg, Coral Bay, St John.** The small star-shaped redoubt taken at dawn in
November 1733. It is a short walk and a very small fort.

**KUBEN, Arendal.** The *Fredensborg* exhibition, with the objects raised from the
wreck and the transcribed journals of the last voyage.

**Odd Fellow Palæet, Bredgade, Copenhagen.** The Berckentin palace, bought by
Heinrich Carl Schimmelmann. Then walk to Christianshavn and look at the warehouses
along the canal. The sugar came here.

**Sølyst, Klampenborg.** Where Ernst Schimmelmann wrote the letter of 18 June 1791
that began the process, in a house paid for by the plantations.
...
<!-- ===== c31_draft_apparatus.md ===== -->

# Chapter 31 — apparatus

*Draft. Glossary blocks are per-section. Question tiers: Recall, Causal,
Counterfactual, Contested. This chapter carries the part coda in `tail_extra`,
unnumbered, after the visit block.*
...
- **den florissante handelsperiode** — the flourishing trade, roughly 1778–1807.
  The word is contemporary; people called it that at the time.
- **stabelplads** — a staple port: a place where cargoes are landed, stored and
  re-shipped. Copenhagen became one of Europe's principal ones.
- **Asiatisk Kompagni** — the Asiatic Company, 1732–1844. The largest non-state
  employer in the monarchy.
- **neutralitetsforbund** — the League of Armed Neutrality: Denmark, Sweden,
  Prussia and Russia, built by Tsar Paul.

**§03 — the King's Deep**

- **Kongedybet** — the deep-water channel off Copenhagen where the Danish line was
  moored.
- **flådebatteri** — a floating battery: a hull with guns and no rig, warped into
  position and unable to move.
- **blokskib** — a blockship: an old ship of the line, similarly moored.

**§05–06 — the war**

- **kanonbåd** — a gunboat: an open rowing vessel with a heavy gun at each end and
  up to sixty oarsmen, useful in narrow calm water against becalmed ships.
- **kaperfart** — licensed privateering: private vessels commissioned to take enemy
  merchant shipping.

**§07 — the money**

- **kurantdaler** — the note issued by the Kurantbank from 1736. By 1813 worth six
  per cent of its face value in silver.
- **rigsbankdaler** — its replacement, at eighteen and a half to a mark of fine
  silver, divided into six mark or ninety-six skilling.
- **statsbankerot** — state bankruptcy. A name given afterwards, and not accurate:
  no insolvency was declared and no creditor's claim extinguished.
- **bankhæftelse** — the bank charge: six per cent of the value of all fixed
  property in the realm, payable in silver or standing as a first mortgage.

**§08–10 — the settlement**

- **helstat** — the whole state: kingdom, duchies and dependencies as one composite
  monarchy. After 1814 it is what is left, and it is what breaks in 1864.
- **almueskole** — the common school of the 1814 ordinances: seven years,
...
**1805 — Trafalgar.** On 21 October 1805 Nelson destroyed the combined French and
Spanish fleets off Cape Trafalgar and was killed doing it. Four years earlier the
same officer had commanded the attack in the King's Deep. The two engagements are
worth holding together because they explain what happened to Denmark: after
Trafalgar the Royal Navy had no serious rival anywhere, which meant that a neutral
merchant fleet was no longer a service the belligerents needed but an obstacle
Britain could simply remove. The bombardment of 1807 was possible because
...
**Checkpoint (after §03)** — Two things about 1801, and popular memory keeps
...
refused the treaty, wrote a constitution at Eidsvoll on 17 May 1814, lost the war
that followed, and entered the Swedish union anyway — as a kingdom with its own
parliament and its own constitution, which it kept. That is the difference between
being transferred and being annexed, and it is the last instalment of chapter 28's
observation that Norway acquired institutions every time the sea route closed.

---

## Myth-check

**The myth.** At Kiel, Denmark's negotiator Edmund Bourke outwitted an exhausted
...
**← 25.** The absolutism of 1660 ends this part with a king who is personally
commanding an army, dictating foreign policy and printing money, and who has nobody
constitutionally able to tell him he is wrong.
...
**→ Part I.** Greenland, Iceland and the Faroes stay with Denmark by a parenthesis
in article four.
...
roughly the entire state revenue of the kingdom over the same years.
...
8. Suppose Denmark had accepted the British ultimatum of August 1807 and handed over
   the fleet in trust. What would it have lost, and what would it have kept?
9. Suppose Tsar Paul had lived through April 1801. What would the British have
   demanded, and could Denmark have refused?

**Contested** — *Where the argument still is*

10. The dead of September 1807 are given as about 1,600 by tradition and about 400
    by recent research. What would settle it, and does the number change the moral
    judgement of the bombardment?
11. Denmark exploited neutrality knowingly and unlawfully for a decade, and was then
    attacked without a declaration of war and its capital shelled. Set out the
    British case and the Danish case, and say whether the first excuses the second.
12. Why has the Bourke story survived so well, when specialists have been
    dismantling it for a century? What does a country get from an anecdote like that
    one?
...
- The peace treaties concluded at Kiel, 14 January 1814: Denmark–Sweden and
  Denmark–Britain, both with Bourke as Danish plenipotentiary.
- *Forordning om Forandring i Pengevæsenet*, 5 January 1813.
- The capitulation of Copenhagen, 7 September 1807.
- Olfert Fischer's official report on the action of 2 April 1801.
...
- Ole Feldbæk's work on the flourishing trade and on Danish neutrality policy is the
  ...
  neutrality was systematic and state-backed rather than incidental.
- On the Kiel parenthesis, the debate runs from the older Danish tradition through
  the twentieth-century revisions to the recent exchange between Thorkild Kjærgaard
  and others; the point at issue is how much British policy, rather than Danish
  ingenuity, produced the exception.
- The death toll of 1807 has been revised downward by recent research and the older
  figure is still the one in general circulation.
- Norwegian and Danish historiography of 1814 have never told the same story, and
  the difference is not about facts but about whether the union is described from
  Copenhagen or from Eidsvoll.

---

## Visit

**Nyholm and the Mastekranen, Copenhagen.** Where the fleet was built and from
where it was taken. The mast crane of 1748 is still standing.

**Kastellet and the ramparts at Østerbro.** The line the British artillery was
firing over in September 1807.

**Vor Frue Kirke.** Burned out in the bombardment and rebuilt by C.F. Hansen in the
