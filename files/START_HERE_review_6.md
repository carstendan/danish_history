...
1. **R-4 and R-5, agreed 21 September as recommended (REVIEW-CONSISTENCY §9.9).** (a) **Ragnhild at Glavendrup** in 08 §04 *What they believed* — `[f]`; the stone, the ship setting, Alle the *goði*, Thor, the curse; first half of the tenth century. (b) **The garrison's dead at Trelleborg** in 10 §08 *Who lived in them* — `[n]`; the cemetery, the mass graves, the strontium results (Price, Frei et al., *Antiquity* 85, 2011). Source every detail before writing it, and check the recommendation's own facts first. Who-lines person · place · date · tag. D-13 applies. Then `vignettes.py` should report no D-9 failure in Parts A–C.
